...
class SoundBehaviour extends Behaviour {
    ...
    testUrlSth:AudioClip|null = null
    ...
    async init(audioCtx:AudioContext,soundFileUrl:string){
        ...
        this.fadeConvolverGainNode1.gain.setValueAtTime(0,this.audioCtx.currentTime)
        this.fadeConvolverGainNode2.gain.setValueAtTime(0,this.audioCtx.currentTime)
        this.fadeConvolverGainNode3.gain.setValueAtTime(0,this.audioCtx.currentTime)
        this.convolver1=this.audioCtx.createConvolver()
        const convolver1Response = await fetch("../../assets/Irs/0_8s_small.mp3")
        ...
        const convolver2Response = await fetch("../../assets/Irs/2_0s_medium.mp3")
        ...
        const convolver3Response = await fetch("../../assets/Irs/2_9s_large.wav")
        ...
        }else if(!this.convolver1||!this.convolver2||!this.convolver3||!this.fadeConvolverGainNode1||
            !this.fadeConvolverGainNode2||!this.fadeConvolverGainNode3||!this.gain_AsConvolver0){
